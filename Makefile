...
TARGETS = jop jop2 jop3 jop4 jop_claude jop_claude2
SRC_jop = jop.c
SRC_jop2 = jop2.c
SRC_jop3 = jop3.c
SRC_jop4 = jop4.c
SRC_jop_claude = jop_claude.c
SRC_jop_claude2 = jop_claude2.c
...
jop_claude: $(SRC_jop_claude)
	$(CC) $(CFLAGS) $(SRC_jop_claude) -o jop_claude $(LDFLAGS)

jop_claude2: $(SRC_jop_claude2)
	$(CC) $(CFLAGS) $(SRC_jop_claude2) -o jop_claude2 $(LDFLAGS)
